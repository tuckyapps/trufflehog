...
def main():
    ...
    parser.add_argument("--since_date", dest="since_date", help="Only scan from a given YYYY-MM-DD date")
...
def clone_git_repo(git_url, **kwargs):
    ...
    try:
        ...
        print("There was an error during cloning:", e.stderr)
        sys.exit(2)
    return project_path
...
def find_strings(git_url, since_commit=None, since_date=None, max_depth=1000000, printJson=False, do_regex=False, do_entropy=True, surpress_output=True,
